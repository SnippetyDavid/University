...
/**
 * This class creates a Simple Vector2 object, holding a x and y value
 * 
...
public class Vector2 {
	...
	/**
	 * This method determines if this Vector2 is [0,0]
	 * 
	...
	/**
	 * This method determines the Euclidean length of the vector
	 * 
	...
	/**
	 * This method determines the squared Euclidean length of the vector
	 * 
	...
	/**
	 * This method sets the component value of the vector
	 * 
	 * @param x
	 *            - The x-component
	 * @param y
	...
	/**
	 * This method adds the component value to the vector
	 * 
	 * @param x
	...
	/**
	 * This method subtracts the component value from the vector
	 * 
	 * @param other
	...
	/**
	 * This method multiplies the vector components by the specified scalar
	 * 
	 * @param scalar
	...
	/**
	 * This method divides the vector components by the specified scalar
	 * 
	 * @param scalar
