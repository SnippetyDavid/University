...
public class GameCheck {
	...
	{
		RightPanel.getBuildButton().setEnabled(false);
		RightPanel.getDiceButton().setEnabled(false);
		RightPanel.getDropOutButton().setEnabled(false);
		RightPanel.getQuestionButton().setEnabled(false);
		RightPanel.getTradeButton().setEnabled(false);
