...
public class PropertySetup {
	...
	static Properties agincourtAve = new Properties("Agincourt Avenue", 1, 20,
			10, 2, true, 20, 70, "brown");
	static Properties shotCard = new Properties("Shot 1", 2, 0, 0, 0,
			false, 0, 0, null);
	static Properties tatesAve = new Properties("Tates Avenue", 3, 40, 20, 2,
			true, 20, 70, "brown");
	...
	static Properties bcbRubble = new Properties("BCB Rubble", 6, 100, 80, 6,
			true, 40, 90, "blue");
	static Properties warp = new Properties("Warp 1", 7, 0, 0, 0, false,
			0, 0, null);
	static Properties dunluceAve = new Properties("Dunluce Avenue", 8, 100, 50,
			6, true, 40, 90, "blue");
	...
	static Properties theologyCentre = new Properties("Theology Centre", 13,
			140, 70, 10, true, 60, 140, "pink");
	static Properties maloneRoad = new Properties("Malone Road", 14, 160, 80,
			12, true, 60, 140, "pink");
	...
	static Properties fitzwilliamStreet = new Properties("Fitzwilliam Street",
			16, 180, 90, 14, true, 80, 180, "orange");
	...
	static Properties mcClayLibrary = new Properties("McClay Library", 26, 260,
			130, 22, true, 120, 260, "yellow");
	static Properties peterFroggatCentre = new Properties(
			"Peter Froggatt Centre", 27, 260, 130, 22, true, 120, 260, "yellow");
	static Properties air = new Properties("Airtricity", 28, 150, 75, 0, true,
			0, 0, null);
	static Properties mbc = new Properties("MBC", 29, 280, 140, 42, true, 120, 260,
			"yellow");
	static Properties gotoLecture = new Properties("Go To Lecture", 30, 0, 0, 0,
			false, 0, 0, null);
	static Properties whitlaHall = new Properties("Whitla Hall", 31, 300, 150,
			26, true, 140, 300, "green");
	static Properties dkb = new Properties("DKB", 32, 300, 150, 45, true, 140, 300,
			"green");
	...
	static Properties botanicGardens = new Properties("Botanic Gardens", 37,
			350, 175, 35, true, 160, 340, "purple");
	...
	static Properties lanyonBuilding = new Properties("Lanyon Building", 39,
			400, 200, 50, true, 160, 340, "purple");
