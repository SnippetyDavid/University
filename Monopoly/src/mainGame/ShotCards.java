...
public class ShotCards {
	...
	static ImageIcon advanceBoojumCard = new ImageIcon("images/ShotCards/Boojum-Twist.png");
	static ImageIcon advanceGoCard = new ImageIcon("images/ShotCards/Go-Twist.png");
	static ImageIcon advanceBotanicCard = new ImageIcon("images/ShotCards/Botanic-Twist.png");
	static ImageIcon advanceLanyonCard = new ImageIcon("images/ShotCards/Lanyon-Twist.png");
	static ImageIcon advanceJailCard = new ImageIcon("images/ShotCards/Lecture-Twist.png");
	static ImageIcon back3SpacesCard = new ImageIcon("images/ShotCards/3spaces-Twist.png");
	static ImageIcon collectBursaryCard = new ImageIcon("images/ShotCards/Bursary-Twist.png");
	static ImageIcon collectPlacementCard = new ImageIcon("images/ShotCards/Placement-Twist.png");
	static ImageIcon collectQuizCard = new ImageIcon("images/ShotCards/Quiz-Twist.png");
	static ImageIcon subtractSpeedingCard = new ImageIcon("images/ShotCards/Speeding-Twist.png");
	static ImageIcon subtractTextBooksCard = new ImageIcon("images/ShotCards/Textbooks-Twist.png");
	static ImageIcon subtractBillsCard = new ImageIcon("images/ShotCards/Bills-Twist.png");
	static ImageIcon subtractDrinksCard = new ImageIcon("images/ShotCards/NightOut-Twist.png");
	...
	public static void collectPlacement(){
		if (LeftPanel.getPlayer1().getPlayerNum() == RightPanel
				.getCurrentPlayer()) {
			LeftPanel.getPlayer1().setPlayerMoney(
					LeftPanel.getPlayer1().getPlayerMoney() + 500);
		} else if (LeftPanel.getPlayer2().getPlayerNum() == RightPanel
				.getCurrentPlayer()) {
			LeftPanel.getPlayer2().setPlayerMoney(
					LeftPanel.getPlayer2().getPlayerMoney() + 500);
		} else if (LeftPanel.getPlayer3().getPlayerNum() == RightPanel
				.getCurrentPlayer()) {
			LeftPanel.getPlayer3().setPlayerMoney(
					LeftPanel.getPlayer3().getPlayerMoney() + 500);
		} else if (LeftPanel.getPlayer4().getPlayerNum() == RightPanel
				.getCurrentPlayer()) {
			LeftPanel.getPlayer4().setPlayerMoney(
					LeftPanel.getPlayer4().getPlayerMoney() + 500);
		}
		Building.updateLabels();
	}
