...
/**
 * This class contains the screen manager that stores the available screens
 * defined within our game. Screens can be added or remove to reflect the
 * evolution of the game. Within the central game loop, the current game screen
 * will be retrieved and updated/rendered.
 * 
...
public class ScreenManager {
	...
	/**
	 * This method adds the specified game screen to the manager.
	 * 
	...
	/**
	 * This method sets the named game screen as the current screen.
	 * 
	 * @param name
	...
	/**
	 * This method returns the current game screen.
	 * 
	...
	/**
	 * This method returns the named game screen.
	 * 
	 * @param name
	 *            - String name reference for the target screen.
	...
	/**
	 * This method removes the specified game screen from the manager.
	 * 
	...
	/**
	 * This method disposes of the manager and all game screens stored within
	 * the manager.
	 */
	public void dispose() {
