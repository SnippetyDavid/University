package uk.co.takeabytestudios.rock_etout.engine;

import java.io.IOException;
import java.util.HashMap;

import uk.co.takeabytestudios.rock_etout.audio.Music;
import uk.co.takeabytestudios.rock_etout.audio.Sound;
...
/**
 * This class is used as an Asset store for holding loaded assets within our
 * game.
 * 
...
public class AssetStore {
	...
	/**
	 * This method adds the specified bitmap asset to the store
	 * 
	 * @param assetName
	...
	/**
	 * This method adds the specified music asset to the store
	 * 
	 * @param assetName
	 *            - Name given to the asset
	 * @param asset
	...
	/**
	 * This method adds the specified sound asset to the store
	 * 
	 * @param assetName
	 *            - Name given to the asset
	 * @param asset
	...
	/**
	 * This method loads and add the specified bitmap asset to the store
	 * 
	 * @param assetName
	 *            - Name given to the asset
	 * @param bitmapFile
	...
	public boolean loadAndAddBitmap(String assetName, String bitmapFile) {
		...
		try {
			...
			Log.e("RocketOut", "AssetStore.loadAndAddBitmap: Cannot load ["
					+ bitmapFile + "]");
			success = false;
		}
	...
	/**
	 * This method loads and add the specified music asset to the store
	 * 
	 * @param assetName
	 *            - Name given to the asset
	 * @param musicFile
	...
	public boolean loadAndAddMusic(String assetName, String musicFile) {
		...
		try {
			...
			Log.e("RocketOut", "AssetStore.loadAndAddMusic: Cannot load ["
					+ musicFile + "]");
			success = false;
		}
	...
	/**
	 * This method loads and add the specified sound asset to the store
	 * 
	 * @param assetName
	 *            - Name given to the asset
	 * @param soundFile
	...
	/**
	 * This method retrieves the specified bitmap asset from the store
	 * 
	 * @param assetName
	...
	/**
	 * This method retrieves the specified music asset from the store
	 * 
	 * @param assetName
	 *            - Name of the asset to retrieve
	...
	/**
	 * This method retrieves the specified sound asset from the store
	 * 
	 * @param assetName
	 *            - Name of the asset to retrieve
