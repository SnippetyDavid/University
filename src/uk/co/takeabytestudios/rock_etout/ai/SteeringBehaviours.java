...
/**
 * This class is used to define the steering behaviours of the AI objects in our
 * game.
 * 
...
public class SteeringBehaviours {
	...
	// Seek and Flee
	/**
	 * This method stores an acceleration vector for the specified body towards
	...
	/**
	 * This method stores an acceleration vector for the specified body away
	 * from the specified target position
	 * 
	 * @param seekingSprite
	 *            - Fleeing sprite
	 * @param targetPosition
	...
	/**
	 * This method outputs an acceleration vector for the specified sprite that
	 * will cause it to arrive with a stopping velocity at the specified target.
	 * 
	...
	/**
	 * This method aligns the orientation of the specified sprite with the
	 * target orientation, using the default align smoothness value.
	 * 
	...
	/**
	 * This method aligns the orientation of the specified sprite with the
	 * target orientation, using the specified align smoothness value.
	 * 
	 * @param aligningSprite
	 *            - Sprite to align
	 * @param targetOrientation
	...
	/**
	 * This method changes the orientation of the specified sprite so that it is
	 * looking at the specified target location.
	 * 
	 * @param aligningSprite
	...
	/**
	 * This method aligns the orientation of the specified sprite with it's
	 * current velocity.
	 * 
	 * @param aligningSprite
	...
	/**
	 * This method separates the specified sprite from the list of other
	 * sprites.
	 * 
	...
	/**
	 * This method separates the specified sprite from the other specified
	 * sprite
	 * 
	 * @param separatingSprite
	 *            - Sprite that should be separated.
