...
public class RightPanel extends JPanel {
	...
	private static HowToPlayWindow htp;
	...
	private static JButton buildPropertyButton;
	...
	private void setupPanel() {
		...
		logArea.append("Welcome to Monopoly");
	...
	private void setupButtons() {
		...
		tradeButton = new JButton ("Offer Trade");
	...
	private void addListeners() {
		...
		tradeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent build) {
				if (!(LeftPanel.getPlayer1().getPropertiesArray().isEmpty()) || !(LeftPanel.getPlayer2().getPropertiesArray().isEmpty())
						|| !(LeftPanel.getPlayer3().getPropertiesArray().isEmpty()) || !(LeftPanel.getPlayer4().getPropertiesArray().isEmpty())){
					
					TradeWindow.startTrade();
				} else {
					JOptionPane.showMessageDialog(null, "No one owns property yet!");
				}
	...
	public static JButton getBuildButton() {
		return buildPropertyButton;
	}
	
	public static JButton getDropOutButton() {
		return surrenderButton;
	}
	
	public static JButton getQuestionButton() {
		return questionButton;
	}
	
	public static JButton getTradeButton() {
		return tradeButton;
	}
	...
	public static void setNextPlayer(int nextPlayer) {
		RightPanel.nextPlayer = nextPlayer;
	}
