...
import uk.co.takeabytestudios.rock_etout.util.Pool;
...
/**
 * This class is the Touch handler which is used to define what happens when
 * screen is touched
 * 
...
public class TouchHandler implements OnTouchListener {
	...
	/**
	 * This method determines if the touch event exists for the specified
	 * pointer ID.
	 * 
	 * @param pointerId
	...
	/**
	 * This method gets the (scaled) y-location of the specified pointer ID
	 * 
	 * Note: The method assumes that the specified pointer ID has a valid touch
	 * location (i.e. that existsTouch(pointerID) is true).
	 * 
	 * @param pointerId
	 *            - ID of the pointer to test for
	 * @return - y-touch location of the specified pointer ID, or Float.NAN if
	 *         the pointer ID does not currently exist
	 */
	...
	/**
	 * This method returns the list of touch events accumulated for the current
	 * frame.
	 * 
	...
	/**
	 * This method resets the accumulator - update the current set of frame
	 * touch events to those accumulated since the last time the accumulator was
	 * reset.
	 * 
