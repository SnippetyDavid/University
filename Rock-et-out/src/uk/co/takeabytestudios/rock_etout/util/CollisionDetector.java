...
/**
 * Collision Detector Class... Not used since we found an easier way to
 * implement collision
 * 
...
public class CollisionDetector {
	...
	/**
	 * This method determines if the two specified bounding boxes are in
	 * collision
	 * 
	 * @param one
	 *            - First bounding box
	...
	/**
	 * This method determines the type of collision between the two bounding
	 * boxes. CollisionType. None is returned if there are no collisions.
	 * 
	 * @param one
	 *            - First bounding box
	 * @param two
	...
	/**
	 * This method determines the type of collision between the two game
	 * objects. If the two objects overlap, then they are separated. The first
	 * game object will be repositioned. The second game object will not be
	 * moved following a collision.
	 * 
