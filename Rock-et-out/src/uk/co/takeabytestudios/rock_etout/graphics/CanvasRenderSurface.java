...
/**
 * Canvas based implementation of the render surface interface. The canvas based
 * render will accept render requests that a game screen draw itself to the
 * surface. The actual draw will be conducted from the GUI thread and as such
 * benefit from hardware acceleration of the canvas draw methods. The cost
 * associated with this benefit is a slightly delayed render (a canvas
 * invalidate request will need to be picked up and proceeded by the GUI thread)
 * 
...
public class CanvasRenderSurface extends View implements IRenderSurface {
	...
	protected RocketOutFragment mGame;
	 ...
	 */
	public CanvasRenderSurface(RocketOutFragment game, Context context) {
		super(context);
